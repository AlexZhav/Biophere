    ...
    <section id="faq" className="py-16 bg-gradient-to-br from-blue-50 to-green-50 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-biosphere-primary/10 rounded-full mb-4">
        ...
        <div className="text-center mt-12">
          ...
          <Link to="/faq" className="inline-flex items-center justify-center px-6 py-3 bg-biosphere-primary text-white rounded-lg hover:bg-biosphere-primary/90 transition-colors font-medium">
            Задать свой вопрос
          </Link>
        </div>
      </div>
