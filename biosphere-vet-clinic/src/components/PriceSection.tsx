    ...
    <section id="prices" className="py-16 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
                ...
                {category.services.map((service, index) => (
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between items-start">
                      ...
                      <Badge variant="secondary" className="ml-2 font-mono text-biosphere-primary">
                        {service.price} ₽
                      </Badge>
                    </div>
        ...
        <div className="text-center mt-8">
          <a href="/pricelist" className="inline-block px-8 py-4 bg-biosphere-primary text-white rounded-lg text-lg font-semibold shadow hover:bg-biosphere-primary/90 transition-colors">
            Полный прейскурант
          </a>
        </div>
      </div>
