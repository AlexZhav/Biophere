const specialists = [
  ...
  { name: 'Жаворонкова Наталия Алексеевна', position: 'Главный врач сети клиник', specialization: 'терапия, визуальная диагностика (УЗИ)', workplace: 'ул. Московская, д. 4', education: 'Московская Ветеринарная Академия', extra_qual: 'Кардиология, УЗИ-диагностика', photo: 'nzhavoronkova.jpg' },
