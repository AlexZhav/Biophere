    ...
    <section id="main-prices" className="py-16 bg-gradient-to-br from-white to-[#e3eaff] dark:bg-[#1f2937] dark:from-[#1f2937] dark:to-[#1f2937]">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-4">
          <Link to="/pricelist" className="inline-block bg-biosphere-primary text-white px-6 py-3 rounded-lg font-medium shadow hover:bg-biosphere-secondary transition-colors">
